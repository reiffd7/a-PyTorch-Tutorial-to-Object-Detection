...
def detect(original_image, model, device, min_score, max_overlap, top_k, suppress=None):
    """
    ...
    for i in range(det_boxes.size(0)):
        ...
        text_location = [box_location[0] + 2.0, box_location[1]]
        textbox_location = [
            box_location[0],
            box_location[1],
            box_location[0] + 4.0,
...
if __name__ == "__main__":
    ...
    detect(original_image, model, min_score=0.2, max_overlap=0.5, top_k=200).show()
